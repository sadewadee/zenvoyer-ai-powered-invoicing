...
const mockTickets = [
  ...
  { id: 'TKT-004', subject: 'Login problems', user: 'help@example.com', status: 'Open', priority: 'High', createdAt: '30 minutes ago' },
  { id: 'TKT-005', subject: 'Feature request: Dark Mode', user: 'darkmodefan@example.com', status: 'Resolved', priority: 'Low', createdAt: '3 days ago' },
];
const kpiCards = [
